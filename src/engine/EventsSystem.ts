...
export const STRATEGIC_EVENTS: GameEvent[] = [
...

  {
    ...
    description: 'A foreign broker offers advanced weapons at a steep price. Worth it?',
    type: 'choice',
    icon: '🔫',
    effects: [],
    choices: [
      {
        id: 'buy_arms',
        text: 'Purchase the weapons (-15 IPCs, +1 tank + 1 artillery)',
        effects: [
          { type: 'ipc_penalty', value: 15 },
          { type: 'unit_spawn', unitType: 'tank', value: 1, target: 'capital' },
          { type: 'unit_spawn', unitType: 'artillery', value: 1, target: 'capital' },
        ],
        cost: 15,
      },
      {
        id: 'decline_arms',
        text: 'Decline — maintain self-sufficiency',
        effects: [{ type: 'morale_boost', value: 1 }],
      },
    ],
    weight: 6,
  ...
  },
  {
    ...
    description: 'Leaked documents embarrass your government, shaking public confidence.',
    type: 'negative',
    icon: '📰',
    effects: [
      { type: 'ipc_penalty', value: 6 },
      { type: 'morale_boost', value: -1 },
    ],
    weight: 7,
    cooldownTurns: 8,
  ...
  {
    id: 'breakthrough_science',
    name: '🔬 Scientific Breakthrough',
    description: 'Your researchers make an unexpected discovery, accelerating the war effort.',
    type: 'positive',
    icon: '🔬',
    effects: [
      { type: 'production_bonus', value: 1, target: 'capital', duration: 3 },
      { type: 'ipc_bonus', value: 5 },
    ],
    weight: 8,
    cooldownTurns: 9,
  },
  {
    id: 'partisan_revolt',
    name: '🔥 Territory in Revolt',
    description: 'Occupied civilians rise up against your garrison forces.',
    type: 'negative',
    icon: '🔥',
    effects: [
      { type: 'territory_revolt' },
      { type: 'unit_loss', unitType: 'infantry', value: 1, target: 'frontline' },
    ],
    weight: 6,
    cooldownTurns: 8,
    conditions: [{ type: 'territory_count', value: 3, comparison: 'gt' }],
  },
  {
    id: 'refugees_flood',
    name: '🚶 Refugee Crisis',
    description: 'Waves of displaced civilians strain your resources but also bring skilled workers.',
    type: 'choice',
    icon: '🚶',
    effects: [],
    choices: [
      {
        id: 'absorb_refugees',
        text: 'Absorb them (-5 IPCs this turn, +production for 2 turns)',
        effects: [
          { type: 'ipc_penalty', value: 5 },
          { type: 'production_bonus', value: 2, target: 'capital', duration: 2 },
        ],
      },
      {
        id: 'turn_away',
        text: 'Turn them away (no cost, lose morale)',
        effects: [{ type: 'morale_boost', value: -1 }],
      },
    ],
    weight: 6,
  ...
  {
    id: 'winter_conditions',
    name: '❄️ Winter Conditions',
    description: 'Bitter cold hampers all movement and attacks across the front.',
    type: 'negative',
    icon: '❄️',
    effects: [
  ...
  },
  {
    ...
    name: '💹 Economic Windfall',
    description: 'Favorable trade conditions fill your treasury beyond expectations.',
    type: 'positive',
    icon: '💹',
    effects: [{ type: 'ipc_bonus', value: 18 }],
    weight: 5,
    cooldownTurns: 10,
  ...
  {
    id: 'air_superiority',
    name: '✈️ Air Superiority Achieved',
    description: 'Your air forces dominate the skies, granting a decisive advantage on the ground.',
    type: 'positive',
    icon: '✈️',
    effects: [
      { type: 'attack_bonus', value: 1, duration: 2 },
  ...
  },
  {
    ...
    description: 'A mole in your intelligence service has been feeding secrets to the enemy.',
    type: 'choice',
    icon: '🃏',
    effects: [],
    choices: [
      {
        id: 'purge_intelligence',
        text: 'Purge the service (-8 IPCs, protect future ops)',
        effects: [
          { type: 'ipc_penalty', value: 8 },
          { type: 'defense_bonus', value: 1, duration: 3 },
        ],
        cost: 8,
      },
      {
        id: 'feed_misinformation',
        text: 'Feed misinformation through the mole (+2 attack for 2 turns)',
        effects: [{ type: 'attack_bonus', value: 2, duration: 2 }],
      },
    ],
    weight: 5,
    cooldownTurns: 12,
  ...
  },
  {
    ...
    name: '📸 War Correspondent Coverage',
    description: 'International press coverage of your victories boosts morale and draws recruits.',
    type: 'positive',
    icon: '📸',
    effects: [
      { type: 'morale_boost', value: 2 },
      { type: 'unit_spawn', unitType: 'infantry', value: 1, target: 'capital' },
    ],
    weight: 7,
    cooldownTurns: 7,
    conditions: [{ type: 'winning' }],
  ...
  {
    id: 'naval_mines',
    name: '💣 Enemy Naval Mines Detected',
    description: 'Intelligence warns of enemy minelaying in key sea lanes, impeding naval movement.',
    type: 'negative',
    icon: '💣',
    effects: [
      { type: 'movement_bonus', value: -1, duration: 2 },
